...
length(meanStdIndices) # 66 features
...
subjectLen <- length(table(joinSubject)) # 30 people
activityLen <- dim(activity)[1] # 6 activities
...
head(output)
write.table(output, "tidy_data_with_means.txt") # write out the 2nd dataset
